...
public class CB_Rocco extends Frame implements ActionListener, WindowListener 

{
...

  {
     ...
     Fenster1.setTitle("Adressbuch_Test");

     Fenster1.setBackground(Color.YELLOW);
     ...
     button.addActionListener(
 	   ...
 	   JLabel l3 = new JLabel("Alias");
 	    ...
 	    JLabel l4 = new JLabel("Wohnort");
 	    
 	    JLabel l5 = new JLabel("Straße");

 	    JLabel l6 = new JLabel ("HausNr.");

 	    JLabel l7 = new JLabel("PLZ");


 	    JLabel l8 = new JLabel ("Telefonnummer");

 	    JLabel l9 = new JLabel ("Telefonnummer");

 	    JLabel l10 = new JLabel ("Handynummer");

 	    JLabel l11 = new JLabel ("E - mail Adresse");
